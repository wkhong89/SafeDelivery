...
public class insertPhone extends AppCompatActivity {
    String android_ID;
    ...
    private void ConnectServer(){
        ...
        final String SIGNIN_URL = "http://203.244.145.214:8084/deliveryQR/connection_test.jsp";
        ...
        class SignupUser extends AsyncTask<String, Void, String> {
            ...
            protected void onPostExecute(String s) {
                ...
                if (s != null) {
                    ...
                    Toast.makeText(insertPhone.this, "서버와의 통신에 문제가 발생했습니다", Toast.LENGTH_SHORT).show();
                }
            }
