...
public class Main2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        intent = new Intent(this, selectDeliveryPage.class);
    ...
    private void ConnectServer() {
        ...
        final String SIGNIN_URL = "http://203.244.145.214:8084/deliveryQR/selectDeliveryPartPage.jsp";
            ...
            protected void onPostExecute(String s) {
                ...
                if (s != null) {
                    try {
                        ...
                        intent.putExtra("delivery_name", jsonObject.getString("delivery_name"));
                    ...
                    Toast.makeText(Main2Activity.this, "서버와의 통신에 문제가 발생했습니다", Toast.LENGTH_SHORT).show();
